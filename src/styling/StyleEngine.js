...
class StyleEngine {
  ...
  _extractThemeStyles(theme) {
    return {
      background: {
        color: theme.colors?.background?.primary || '#0a0a0f',
        card: theme.colors?.background?.card || '#16161e',
        secondary: theme.colors?.background?.secondary || '#1f1f2e'
      },
      typography: {
